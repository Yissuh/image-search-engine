...
if __name__ == "__main__":
    ...
    searcher = ImageSearcher(index_path="siglip2b-16-256.index", meta_path="siglip2b-16-256-metadata.pkl")
    
    # Provide the query image path
    query_path = "images/ramen_rotated.jpg"  # Replace with your actual query image path
